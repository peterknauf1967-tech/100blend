...
const CACHE = "blend-einkauf-v66";   /* v27: Webhook-prompt; Zahnrad-Bug + Sprachumschalter; Gear-Click Mobile-Fix; Fehlerdiagnose; Postkorb-Race + flushQueue; CORS-Fix; FAB ueber Nav + Screenshot-Upload; Claude-Button Postkorb (msg_id, Antworten sichtbar) + firebase-sync claude_answers/*, 02.09.2026 */
const FILES = [
